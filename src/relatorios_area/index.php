        ...
        <table class="table">
            ...
            <tr>
                ...
                <td class="w-100">
                    ...
                    <span style="color:#a1a1a1; font-size:10px;"><?=($r[$i]*1)." beneficiado(s) que correspondem a ".number_format(($r[$i]*100/$total),0,false,false)?>% do total de <?=$total?> beneficiado(s).</span>
                </td>
            </tr>
            <?php
            }
